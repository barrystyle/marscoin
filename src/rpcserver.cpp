...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Marscoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Marscoin server stopping";
}
...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    { "blockchain",         "checkpow",               &checkpow,               true,      true,       false },
    ...
    { "mining",             "getauxblock",            &getauxblock,            true,      true,       false },
    { "mining",             "createauxblock",         &createauxblock,         true,      true,       false },
    { "mining",             "submitauxblock",         &submitauxblock,         true,      true,       false },
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use marscoind, or the -server option to marscoin-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> marscoin-cli " + methodname + " " + args + "\n";
}
